...
import type { DashboardData, TaskStatus } from "@/types/models";
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        ...
                        {data.todays_tasks.length === 0 && (
                          <tr>
                            <td colSpan={5} className="px-4 py-8 text-center text-muted-foreground">No tasks due today.</td>
                          </tr>
                        )}
                      </tbody>
                    </table>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        ...
                        {data.upcoming_deadlines.length === 0 && (
                          <tr>
                            <td colSpan={4} className="px-4 py-8 text-center text-muted-foreground">No upcoming deadlines.</td>
                          </tr>
                        )}
                      </tbody>
                    </table>
